...
const MatchRow: React.FC<MatchRowProps> = ({ match }) => {
    ...
    return (
        <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-premium border border-gray-100 dark:border-slate-700 overflow-hidden hover-lift mb-4 relative">
            {/* Status Badge */}
            ...
            <div className="p-6 relative">
                <div className="flex items-center justify-between gap-6">
                    ...
                    <div className="flex-1 flex items-center gap-4">
                        <div className="w-12 h-12 relative bg-gray-50 dark:bg-slate-700 rounded-xl p-2 flex-shrink-0">
                            {homeTeamData?.logo ? (
                                <Image
                        ...
                        <div className="flex-1">
                            <p className="font-bold text-gray-900 dark:text-white text-base truncate">{match.homeTeam}</p>
                    ...
                    <div className="flex-1 flex items-center gap-4 flex-row-reverse">
                        ...
                        <div className="flex-1 text-right">
                            <p className="font-bold text-gray-900 dark:text-white text-base truncate">{match.awayTeam}</p>
